...
public class CChangeColorMat : CAction
{
	...
	public static CChangeColorMat create(Material pMaterial, Color pEndColor,float pDuration)
	{
		GameObject actionObject = new GameObject();
		actionObject.name = "CChangeColorMat";
		
		CChangeColorMat action = actionObject.AddComponent<CChangeColorMat>();
		action.actionWith(pMaterial, pEndColor, pDuration);
