...
public class CChangeColorLabelAtlas : CAction
{
	public CLabelAtlas _TargetLabel = null;
	...
	public static CChangeColorLabelAtlas create(CLabelAtlas pLabel, Color pEndColor,float pDuration)
	{
		GameObject actionObject = new GameObject();
		actionObject.name = "CChangeColorLabelAtlas";
		
		CChangeColorLabelAtlas action = actionObject.AddComponent<CChangeColorLabelAtlas>();
		action.actionWith(pLabel, pEndColor, pDuration);
		
		action.autoReleaseCallBack = action.autoReleaseAfterCompletion;
		return action;
	}
	
	public void actionWith(CLabelAtlas pLabel, Color pEndColor,float pDuration)
	{
	...
	override public void runAction()
	{
		...
		Color tStartColor = _TargetLabel.getLabelColor();
	...
	override public void setCompletion(float completion)
	{
		...
		_TargetLabel.setLabelColor(mColor);
	}
