...
public class CRotateFromTo : CAction {
	...
	public static CRotateFromTo create(GameObject pTargetObject,Vector3 pStartRot, Vector3 pEndRot,float pDuration)
	{
		GameObject actionObject = new GameObject();
		actionObject.name = "CRotateFromTo";
		
		CRotateFromTo action = actionObject.AddComponent<CRotateFromTo>();
		action.actionWith(pTargetObject,pStartRot, pEndRot,pDuration);
