...
public class CMoveBy : CAction
{
	...
	public static CMoveBy create(GameObject pTargetObject, Vector2 pEndPos,float pDuration)
	{
		GameObject actionObject = new GameObject();
		actionObject.name = "CMoveBy";
		
		CMoveBy action = actionObject.AddComponent<CMoveBy>();
		action.actionWith(pTargetObject, pEndPos,pDuration);
	...
	override public void runAction()
	{
		...
		_DestinationPos = _StartPos + _endPos;
